...
We define color and fill as mapping aesthetics because it can be specified with a word, a phrase, or an acronym. Alpha is a characteristic of the plotting geom because it has a set of values it has to stay within.
...
The violin plots more easily identify the general spread of plastic waste per capita for each continent. Whereas, the box plot more easily show and identify the outliers of each continent.
...
Based on the scatterplot, an assessment can be made that when there is less plastic waster per capita, there is more mismanaged plastic waste per capita.
...
Based on the colored scatterplot, Europe seems to have the best grouping, with both low plastic waste per capita and low mismanaged plastic waste per capita. Whereas, Africa and Asia seem to be the two continents with the largest plastic waste per capita and mismanaged plastic waste per capita spread. Then there is North America with a huge outlier for both x and y axes.
...
Neither graph seems to have a more apparent linear association to me, however, the coastal population seems to have a wider spread than total population.
...
Based on the graph shown, I can see that Africa and North America appear to have the largest spread in data whereas Europe appears to have the tightest spread.
